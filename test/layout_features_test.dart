...
void main() {
  group('onLayoutModeChanged callback', () {
    testWidgets('callback is triggered when layout mode changes',
          ...
          expect(callbacks.length, greaterThan(initialCallbacks),
              reason: 'Callback should fire when transitioning from 300px to 1600px');
    ...
    testWidgets('callback shows correct mode transitions',
            (tester) async {
  ...
  group('Debug Overlay', () {
    testWidgets('overlay is shown when debugShowLayoutMode is true',
          ...
          expect(
              find.textContaining(RegExp(r'COMPACT|MEDIUM|EXPANDED')),
              findsOneWidget);
